...
// Strip any trailing slash so `${SITE_URL}${path}` (path always starts with
// "/") can never produce a malformed `//` URL in sitemaps, canonicals, etc.
...
export const DEFAULT_DESCRIPTION = `Facial surgery, hair transplant & aesthetic dentistry by ${site.doctor.name} — rhinoplasty, facelift, Botox, smile design in ${site.city}.`;
...
const SITE_KEYWORDS = [
  "facial surgery Mumbai",
  "facial plastic surgery",
  "aesthetic clinic Mumbai",
  "aesthetic dentistry",
  "smile design Mumbai",
  "dermatology Kandivali",
  "rhinoplasty Mumbai",
  "facelift Mumbai",
  "blepharoplasty",
  "jaw contouring",
  ...
  "PRP therapy Mumbai",
  "maxillofacial surgeon Mumbai",
  "cosmetic surgeon Kandivali West",
  "facial surgeon near me",
  "hair transplant Kandivali",
  site.city,
  site.doctor.name,
  site.fullName,
];
...
export const ROOT_METADATA = {
  ...
  verification: {
    other: {
      "msvalidate.01": "E223DFA6D62C21A505C85FB233F46890",
    },
  },
  formatDetection: {
    email: false,
