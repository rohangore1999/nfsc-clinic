...
export const site = {
  ...
  about: {
    ...
    team: {
      ...
      // Placeholder roster per PLAN.md — replace with real team before launch.
      members: [
        {
          name: "Dr. Nikhil",
          role: "Lead Surgeon",
          degree: "MDS Oral & Maxillofacial Surgery",
          specialties: ["Rhinoplasty", "Jaw Surgery", "Facelift"],
        ...
        },
        {
          ...
          specialties: ["Facial Aesthetics", "Botox", "Fillers"],
        ...
        },
        {
          ...
          specialties: ["Hair Transplant", "PRP", "GFC"],
        ...
        },
        {
          ...
          specialties: ["Skin Treatments", "Laser Therapy", "Chemical Peels"],
